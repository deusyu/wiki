  ...
  <a-layout>
    <a-layout-content :style="{ background: '#fff', padding: '24px', margin: 0, minHeight: '280px' }">
      <div class="aliyun">
        ...
        <br>
        <div style="color: rgb(194, 79, 74)"><b>还没购买搬瓦工的可以先telegram联系，非常便宜！！！</b></div>
        <div >
          <img style="width: 55vw; min-width: 330px;" src="https://bloggerback-1259552297.cos.ap-chengdu.myqcloud.com/%E7%99%BD%E5%A1%94wiki%E7%9F%A5%E8%AF%86%E5%BA%93/iShot2021-09-05%2022.10.52.png">
        </div>
      </div>
    </a-layout-content>
  </a-layout>
